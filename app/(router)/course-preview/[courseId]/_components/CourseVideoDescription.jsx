      ...
      <h2 className='mt-5 text-[17px] font-semibold'>
        {
          ...
          <Button onClick={()=>setChapterCompleted(courseInfo?.chapter[activeChapterIndex]?.id)}>Mark Completed</Button></span>
          :<span>About this Course</span>
        }
        </h2>
      <div>
        {watchMode?
        <Markdown className='text-[13px] font-light mt-2 leading-7'>{courseInfo?.chapter[activeChapterIndex]?.shortDesc}</Markdown>
